class SetupBusinessTables < ActiveRecord::Migration[8.0]
  def change
    # LOJA (apenas esta, pois contratantes já existe)
    ...
    unless column_exists?(:users, :usu_nome)
      ...
      User.update_all(usu_nome: 'Usuário', usu_telefone: '000000000')
    ...
    # Renomeia colunas se ainda não foram renomeadas
